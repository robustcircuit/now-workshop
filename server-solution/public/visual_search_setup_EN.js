...
const repeat_trials = 1; //[SOLUTION: reduce to 1 for development] how many times to repeat each trial type
                                                 
const block_number = 1; //[SOLUTION: reduce to 1 for development] how many blocks to include in the experiment 
